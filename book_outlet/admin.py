...
from .models import Book, Author, Address, Country          # importing my model

# This is really useful element to customize the admin page of your project. 
# You are able to access the database there, edit and perform a lot of operations that might be of help when it 
...
admin.site.register(Country) #registering my model